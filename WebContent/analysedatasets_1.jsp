...
<table>
	<tr height="250px">
		...
		<div class="newest-img" style="height: 145px; width: 170px;"><a
			href="Product.jsp?productName=<%=productName%>&Category=<%=Category%>">
		<img src="<%=imageURL%>" alt="<%=productName%>" height="145px"
			width="170px" /></a></div>
		</div>
		</td>
	</tr>

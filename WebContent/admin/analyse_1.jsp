...
<div class="main">
  ...
  <div class="hbg">
    <div class="hbg_resize">
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="uIndex.jsp">Home</a></li>
          <li><a href="uSupport.jsp">Support</a></li>
          <li><a href="uAbout.jsp">About Us</a></li>
          
<!--          <li><a href="adAnalyse.jsp">Analyse</a></li>-->
...
<div class="content">
    <div class="content_resize">
      <div class="mainbar">
       ...
       <h6><a href="Index.jsp" style="font-size:16px; text-decoration:none; "><BR><p><h7>Sign Out</h7></p></a></h6>
      <div class="clr"></div>
    </div>
  </div>

...
<div class="content">
 <div class="content_resize">
   ...
   <div class="mainbar">
<div class="article">
<form method=post action="TelevisionData.jsp" name="AddDetails" >
  <p class="style3">Add Television Details </p>
...
<tr>
  ...
  <tr>
    <td height="35"><strong>TYPE:</strong></td>
    <td><input name="type" type="text" id="type" size="20"></td>
  </tr>
  <tr>
    <td height="35"><strong>SCREEN SIZE(RESOLUTION): </strong></td>
    <td><input name="screen" type="text" id="screen" size="20"></td>
  </tr>
  <tr>
    <td height="35"><strong>AUDIO:</strong></td>
    <td><input name="audio" type="text" id="audio" size="20"></td>
  </tr>
  <tr>
    <td height="35"><div align="left"><strong>VIDEO:</strong></div></td>
    <td><input name="video" type="text" id="video" size="20"></td>
  </tr>
  <tr>
    <td height="35"><strong>POWER: </strong></td>
    <td><input name="power" type="text" id="power" size="20"></td>
  </tr>
  <tr>
    <td height="35"><strong>DESIGN AND DIMENSIONS: </strong></td>
    <td><input name="design" type="text" id="design" size="20"></td>
  </tr>
  <tr>
    <td height="35"><div align="left"><strong>PRICE:</strong></div></td>
    <td><input name="price" type="text" id="price" size="20"></td>
  </tr>
  <tr>
    <td height="34"><div align="left"><strong>IMAGE URL :</strong></div></td>

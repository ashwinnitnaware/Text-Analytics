    ...
    <div class="hbg_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="uAbout.jsp">About Us</a></li>
          <li><a href="uContact.jsp">Contact Us</a></li>
        </ul>
      </div>
    </div>
  </div>

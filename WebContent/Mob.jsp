    ...
    <div class="hbg_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="adContact.jsp">Contact Us</a></li>        </ul>
        </ul>
      </div>
    </div>
  </div>
...
<table width="571">
  <tr>
    <td width="192" colspan="2"><strong>Company:</strong> </td>
  ...
  <tr>
    <td colspan="2"><strong>Keypad:</strong></td>
  ...
  <tr>
    <td colspan="2"><strong>ImageUrl:</strong></td>

...
<div class="content">
 <div class="content_resize">
   ...
   <div class="mainbar">
<div class="article">
<form method=post action="ComputerData.jsp" name="AddDetails" >
  <p class="style3">Add Computer Details </p>
...
<tr>
  ...
  <tr>
    <td height="34"><div align="left"><strong>MEMORY</strong> <strong>:</strong> </div></td>
    <td><input name="memory" type="text" id="memory" size="20"></td>
  </tr>
  <tr>
    <td height="39"><div align="left"><strong>DISPLAY</strong> <strong>:</strong> </div></td>
    <td><input name="display" type="text" id="display" size="20"></td>
  </tr>
  <tr>
    <td height="35"><div align="left"><strong>AUDIO</strong> <strong>:</strong> </div></td>
    <td><input name="audio" type="text" id="audio" size="20"></td>
  </tr>
  <tr>
    <td height="34"><div align="left"><strong>POWER</strong> <strong>:</strong> </div></td>

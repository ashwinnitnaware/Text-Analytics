  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar" style="width:665px;">
        <div class="article">
          <h2><span>Support by <span class="style1">MAGDKART</span></span></h2>
          <div class="clr"></div>
          ...
          <p align="justify"><span class="style1">MAGDKART</span>  offers products that enable small &amp; medium size businesses generate business leads, establish their credibility and use business information (feedback) for their business promotion.</p>
        </div>
        <div class="article">
          <h2><span>Our</span> Contact</h2><div class="clr"></div>
          <p align="justify"><strong>Email Us: : <span class="style1">MAGDKART</span>@MAG.com</strong></p>
		  <p align="left"></br> Contact no :1800109109</p>
          <p align="justify">
        </div>
      </div>

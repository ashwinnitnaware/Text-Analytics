...
public class Constants {
	...
	static {
		...
		try {
			properties.load(new FileInputStream("F:/Sentimental Analysis/Text Analytics/WebContent/conf/Rules.properties"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public static String gateHome = "F:/Sentimental Analysis/Text Analytics/gate-7.0-build4195-ALL/gate-7.0-build4195-ALL";
}
